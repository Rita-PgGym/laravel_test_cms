...
//本：更新画面
Route::post('/booksedit/{book}',[BookController::class,"edit"])->middleware(['auth'])->name('book_edit'); //通常
Route::get('/booksedit/{book}', [BookController::class,"edit"])->middleware(['auth'])->name('edit');      //Validationエラーありの場合
